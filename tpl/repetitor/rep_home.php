...
111111
    ...
    ?>
    <ul class="pagination">
        <li <?php if ($offset == 0): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="/">1</a></li>
        <li <?php if ($offset == 10): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="?page=10">2</a></li>
        <li <?php if ($offset == 20): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="?page=20">3</a></li>
        <li <?php if ($offset == 30): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="?page=30">4</a></li>
        <li <?php if ($offset == 40): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="?page=40">5</a></li>
        <li <?php if ($offset == 50): echo 'class="disabled"'; endif;?>><a class="next page-numbers" href="?page=50">6</a></li>
    </ul>
<!-- repetitor home/ -->                    